...
if (!function_exists('software_company_elementor_after_setup_theme')) {
	...
	function software_company_elementor_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'software-company-elementor') {
			wp_redirect(admin_url('themes.php?page=software_company_elementor_about'));
		}
	}
