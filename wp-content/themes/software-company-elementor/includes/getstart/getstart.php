    ...
    <div class="inner-cont">
	    <div class="tab-sec">
	    	<div class="tab">
				...
				<button class="tablinks" onclick="software_company_elementor_open_tab(event, 'wpelemento_importer_editor')"><?php esc_html_e( 'Demo Import', 'software-company-elementor' ); ?></button>
