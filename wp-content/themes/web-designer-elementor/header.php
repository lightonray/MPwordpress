...
?>
<?php if(get_theme_mod('web_designer_elementor_preloader_hide','')){ ?>
	<div class="loader">
		<div class="preloader">
	    <div class="diamond">
	        <span></span>
...
<header id="site-navigation" class="header text-center text-md-left">
	...
	<div class="topheader py-3 <?php if( get_theme_mod( 'web_designer_elementor_sticky_header',false) != '') { ?>sticky-header<?php } else { ?>close-sticky <?php } ?>">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 align-self-center">
					<div class="logo text-center text-md-left mb-3 mb-md-0">
						...
						<div class="logo-content">
							<?php
								if ( get_theme_mod('web_designer_elementor_display_header_title', true) == true ) :
									echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name')) . '">';
									echo esc_attr(get_bloginfo('name'));
									echo '</a>';
								endif;
								if ( get_theme_mod('web_designer_elementor_display_header_text', true) == true ) :
